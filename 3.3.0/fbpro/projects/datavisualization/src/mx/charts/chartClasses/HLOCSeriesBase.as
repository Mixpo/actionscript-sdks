...
public class HLOCSeriesBase extends Series implements IColumn
{
     ...
     *  @inheritDoc
     */
    override public function get items():Array /* of Object */
    {
                                                  ...
                                                  unscaledHeight:Number):void
    {
        ...
        var renderCache:Array /* of Object */ = renderData.filteredCache;
    ...
    override public function getItemsInRegion(r:Rectangle):Array /* of ChartItem */
    {
        ...
        else if (dimension == CartesianTransform.HORIZONTAL_AXIS)
        {
            if (_xField != "")
            {
                     ...
                     DataDescription.REQUIRED_MIN_INTERVAL) != 0)
                {
                    ...
                    var sortedCache:Array /* of Object */ = _renderData.cache.concat();
    ...
    override protected function getMissingInterpolationValues(
                                    sourceProps:Object, srcCache:Array /* of Object */,
                                    destProps:Object, destCache:Array /* of Object */,
    ...
    {
        var cache :Array /* of Object */ = renderData.filteredCache;
