...
public interface IChartElement extends IFlexDisplayObject
{
     ...
     */
    function describeData(dimension:String, requiredFields:uint):Array;
     ...
     */
    function collectTransitions(chartState:Number,transitions:Array):void;
     ...
     */
    function claimStyles(styles:Array,firstAvailable:uint):uint;
}
