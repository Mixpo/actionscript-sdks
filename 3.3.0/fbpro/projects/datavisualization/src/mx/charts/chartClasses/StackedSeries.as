...
public class StackedSeries extends Series
{
     ...
     *  Storage for the type property.
     */
    private var _allowNeg:Boolean = false;  
     ...
     *  @private
     */
    mx_internal override function clearSeriesItemsState(clear:Boolean, state:String = ChartItem.NONE):void
    {
