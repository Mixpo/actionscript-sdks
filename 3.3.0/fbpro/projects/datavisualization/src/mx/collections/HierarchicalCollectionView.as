                                        ...
                                        implements IHierarchicalCollectionView, IXMLNotifiable
{
                            ...
                            argOpenNodes:Object = null):void
    {
        ...
        this.hierarchicalData.addEventListener(CollectionEvent.COLLECTION_CHANGE,
                                  collectionChangeHandler,
                                  false,
                                  EventPriority.DEFAULT_HANDLER,
                                  true);
    ...
    public function contains(item:Object):Boolean
    {
        ...
        while (!cursor.afterLast)
        {
            ...
            {
                // item is pending.
                // we are not sure if the item is present or not - so return false
                return false;
            }
        }
        return false;
    ...
    public function disableAutoUpdate():void
    {
        ...
        for (var obj:Object in childrenMap)
            ICollectionView(childrenMap[obj]).disableAutoUpdate();
    }
    ...
    public function enableAutoUpdate():void
    {
        ...
        for (var obj:Object in childrenMap)
            ICollectionView(childrenMap[obj]).enableAutoUpdate();
    }
    ...
    private function internalRefresh(dispatch:Boolean):Boolean
    {
        ...
        for each(obj in openNodes)
        {
            ...
            if (!(coll.filterFunction == null && filterFunction == null))
            {
        ...
        for each(obj in openNodes)
        {
            ...
            if (sortCanBeApplied(coll) && !(coll.sort == null && sort == null))
            {
                coll.sort = sort;
                coll.refresh();
                dispatch = true;
    ...
    public function openNode(node:Object):void
    {
        ...
        _openNodes[UIDUtil.getUID(node)] = node;
