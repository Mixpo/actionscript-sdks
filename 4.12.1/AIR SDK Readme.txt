...
TEMPLATES/AIR
 ...
 - Descriptor.4.0.xsd - An XML Schema Definition file for the AIR 4.0 application descriptor file.

 - Descriptor.13.0.xsd - An XML Schema Definition file for the AIR 13.0 application descriptor file.
...
TEMPLATES/EXTENSIONS
 ...
 - Descriptor.4.0.xsd - An XML Schema Definition file for the AIR 4.0 extension descriptor file. 

 - Descriptor.13.0.xsd - An XML Schema Definition file for the AIR 13.0 extension descriptor file. 
...
TEMPLATES/EXTENSIONS/iOS
 ...
 - Descriptor.4.0.xsd - An XML Schema Definition file for the AIR 4.0 iOS platform descriptor file. 

 - Descriptor.13.0.xsd - An XML Schema Definition file for the AIR 13.0 iOS platform descriptor file. 
